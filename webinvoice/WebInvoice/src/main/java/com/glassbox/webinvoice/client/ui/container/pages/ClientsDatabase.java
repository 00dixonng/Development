...
public class ClientsDatabase {
   ...
   */
  public static class ClientInfo implements Comparable<ClientInfo> {
   ...
   */
  public static ClientsDatabase get() {
    if (instance == null) {
   ...
   */
  private ListDataProvider<ClientInfo> dataProvider = new ListDataProvider<ClientInfo>();

  /**
   * The map of contacts to her friends.
   */
  private final Map<Integer, Set<ClientInfo>> friendsMap =
      new HashMap<Integer, Set<ClientInfo>>();
   ...
   */
  public void addContact(ClientInfo contact) {
    List<ClientInfo> contacts = dataProvider.getList();
   ...
   */
  public void addDataDisplay(HasData<ClientInfo> display) {
  ...
  public ListDataProvider<ClientInfo> getDataProvider() {
    return dataProvider;
  }
   ...
   */
  public Set<ClientInfo> queryFriends(ClientInfo contact) {
    Set<ClientInfo> friends = friendsMap.get(contact.getId());
    if (friends == null) {
      // Assign some random friends.
      friends = new HashSet<ClientInfo>();
  ...
  private ClientInfo createContactInfo() {
    ClientInfo contact = new ClientInfo();
